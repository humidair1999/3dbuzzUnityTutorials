		...
		switch (terrain.toolModeInt) {
			...
			foreach (SplatPrototype splatPrototype in terrain.splatPrototypes) {
				...
				if (nTextures == 0) {
                    ...
                    splatPrototype.texture = EditorGUILayout.ObjectField("Cliff texture", splatPrototype.texture, typeof(Texture2D), allowSceneObjects: true) as Texture2D;
				} else {
                    ...
                    splatPrototype.texture = EditorGUILayout.ObjectField("Texture " + nTextures, splatPrototype.texture, typeof(Texture2D), allowSceneObjects: true) as Texture2D;
				}
				GUI.skin = terrain.guiSkin;
				textureRect.x += 146;
